...
███████╗   ██║   ███████╗███████╗██║  ██║███████╗███████║╚██████╔╝███████╗██║
╚══════╝   ╚═╝   ╚══════╝╚══════╝╚═╝  ╚═╝╚══════╝╚══════╝ ╚═════╝ ╚══════╝╚═╝
Version: v2.7.1.20241218

请输入各项指标Spec:
眼宽 Width(UI) Spec(若无直接回车跳过): 0.51
眼高 Height(mv/units) Spec(若无直接回车跳过): 50
眼域 Area(units) Spec (若无直接回车跳过):
FOM Spec (若无直接回车跳过):
folder: Bridge-48_03.07-Deivce-0xa2dc15b3-GEN5-auto/default-eye
LaneNum            Width(UI)    Height(Units)      Area         FOM
--------           ---------    -------------      -----        ----
